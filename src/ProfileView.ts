...
export async function ProfileView (
  ...
  const styles = {
    grid: styleMap({
      ...responsiveGrid(),
      ...paddingSmall(),
      background: `radial-gradient(circle, ${profileBasics.backgroundColor} 80%, ${profileBasics.highlightColor} 100%, ${profileBasics.cornerSquareColor}, ${profileBasics.cornerDotColor}, 100% )`,
    }),
    card: styleMap(card()),
    chat: styleMap({
      ...card(),
